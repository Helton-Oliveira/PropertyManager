...
public class OwnerControllerTest {
   ...
   @BeforeEach
     public void setup() {
        ...
        this.userResponse = new UserResponse(3L, "Eduardo", "eduardo.test@example.com", "41230752072", "9938658560", "TENANT", "senha123");
        this.owner = new Owner(this.userResponse);
        List<UserResponse> userResponsesList = List.of(this.userResponse);
        this.pageResponse = new PageImpl<>(userResponsesList);
        this.updatedUser = new UserResponse(3L, "Francisco", "francisco.test@example.com", "41230752045", "9938658561", "OWNER", "senhaForte123");
    }
    ...
    void second_scenario() throws Exception {
       ...
       var response = mvc.perform(
        ...
        verify(service).update(eq(3L), any(UserRequest.class));
    }
